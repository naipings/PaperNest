...
export function SettingsView() {
  ...
  return <main className="settings-page"><header className="page-heading">
    ...
    {section === "privacy" && <><h2><ShieldCheck size={19} />隐私与安全</h2><div className="privacy-grid"><article><Laptop /><strong>单机单用户</strong><p>不需要账号，不连接云同步服务。</p></article><article><LockKeyhole /><strong>最小文件权限</strong><p>桌面端只访问受管资料目录和你明确选择的文件。</p></article><article><Download /><strong>默认离线</strong><p>关闭在线元数据与论文雷达时，应用不会向外网发起请求；雷达仅在你点击「推荐今日论文」时采集元数据。</p></article></div><p className="warning-note">V1 不提供数据库或备份加密。Windows 用户账户权限是默认访问边界。</p></>}
