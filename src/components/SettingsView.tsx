...
import { Archive, Database, Download, HardDrive, Laptop, LockKeyhole, Palette, Radar, RotateCcw, Save, Settings, ShieldCheck, SlidersHorizontal, Sparkles, Tags as TagsIcon, UserRound } from "lucide-react";
...
export function SettingsView() {
  ...
  return <main className="settings-page"><header className="page-heading">
    ...
    {section === "privacy" && <><h2><ShieldCheck size={19} />隐私与安全</h2><div className="privacy-grid"><article><Laptop /><strong>单机单用户</strong><p>纯本地使用，数据留在本机。</p></article><article><LockKeyhole /><strong>最小文件权限</strong><p>桌面端只访问受管资料目录和你明确选择的文件。</p></article><article><Download /><strong>按需联网</strong><p>在线元数据与论文雷达默认关闭；开启后，Crossref 在你手动查询时联网，雷达在你点击「推荐今日论文」时采集元数据。</p></article></div><p className="warning-note">V1 不提供数据库或备份加密。Windows 用户账户权限是默认访问边界。</p></>}
